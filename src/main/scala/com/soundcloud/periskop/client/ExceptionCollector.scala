...
class ExceptionCollector {
  ...
  /**
    ...
    */
  def add(throwable: Throwable, severity: Severity = Severity.Error): Unit = addExceptionWithContext(ExceptionWithContext(throwable, severity))
  ...
  private def addExceptionWithContext(exception: ExceptionWithContext): Unit = {
    exceptions.compute(exception.aggregationKey, new BiFunction[String, ExceptionAggregate, ExceptionAggregate] {
